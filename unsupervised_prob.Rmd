...
\cite{greenacre1987geometric}.

\begin{figure}
\centering
\includegraphics[width=7.5cm]{figure/lda_simplex_view}
\caption{The simplex view of Latent Dirichlet Allocation.}
...
Factorization (NMF) literature \cite{wang2013nonnegative, berry2007algorithms,
lee2001algorithms}.
...
model
\begin{align*}
N &\sim \Pois\left(\Theta B^{T}\right) \\
\Theta &\sim \Gam\left(a_{0} 1_{D \times K}\right, b_{0} 1_{D \times K}) \\
