...
title: "Evalfuating Unsupervised Probabilistic Models of the Microbiome"
date: "`r Sys.Date()`"
keep-tex: true
output:
  bookdown::pdf_book:
...
```{r betacontours1, fig.width = 7, fig.height = 4, eval = TRUE}
```

```{r betacontours2, fig.width = 7, fig.height = 4, eval = TRUE}
```
