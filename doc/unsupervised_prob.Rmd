...
\setstretch{1}
\fontsize{8pt}{8pt}
```{r visualizethetas, out.height = 4, fig.cap = "Visualized scores from the NMF experiment, on data without any zero inflation."}
```
\endgroup
...
\setstretch{1}
\fontsize{8pt}{8pt}
```{r visualizebetas, out.height = 4, fig.cap = "Posteriors for the two-dimensional latent factors, across simulation settings."}
```
\endgroup
...
\setstretch{1}
\fontsize{8pt}{8pt}
```{r visualizezinfthetas, out.height = 8, out.width = 8, fig.cap = "Each panel displays the estimated scores for a different simulation setting, with a focus on the effect of zero inflation. Columns distinguish between different zero-inflation probabilities and modeling techniques."}
```
\endgroup
...
\setstretch{1}
\fontsize{8pt}{8pt}
```{r visualizezinfbetas, out.height = "6in", out.width = "6in", fig.cap = "The analogous display for estimated latent factors, across zero-inflation regimes."}
```
\endgroup
...
include_graphics(c("figure/heatmaps-1.png", "figure/heatmaps-2.png")) 
```
\endgroup
...
include_graphics("figure/visualize_lda_theta_boxplot-1.png")
```
\endgroup
\elandscape
...
include_graphics("figure/visualize_lda_beta-1.png")
```
\endgroup
\elandscape
...
include_graphics("figure/unigramboxplots-1.png")
```
\endgroup
\elandscape
...
include_graphics("figure/visualize-alpha-1.png")
```
\endgroup
...
include_graphics("figure/visualize-mu-1.png")
```
\endgroup
\elandscape
