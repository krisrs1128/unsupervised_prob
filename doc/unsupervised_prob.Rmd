...
\@ref(unigramevals). That the scores and loadings from the posterior predictive
are close to those from the observed data is expected. However, it is actually
