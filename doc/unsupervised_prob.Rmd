...
\setstretch{1}
\fontsize{8pt}{8pt}
```{r betacontours, fig.width = 7, fig.height = 7, eval = TRUE}
```
\endgroup
...
```{r betaboxplot1, fig.width = 8, fig.height = 4.5, eval = TRUE}
```

```{r betaboxplot2, fig.width = 8, fig.height = 2, eval = TRUE}
```

\begingroup
\setstretch{1}
\fontsize{8pt}{8pt}
```{r betahistograms, eval = TRUE}
```
\endgroup
