...
\setstretch{1}
\fontsize{8pt}{8pt}
```{r visualizethetaboxplotfigure, fig.width = 10, fig.height = 8, fig.cap = "Boxplots of approximate posteriors for estimated mixture memberships, and their evolution over time.", echo = FALSE}
...
\setstretch{1}
\fontsize{8pt}{8pt}
```{r visualizebetafigure, fig.width = 10, fig.height = 6, fig.cap = "The distribution over microbes associated with each LDA topic.", echo = FALSE}
