...
\setstretch{1}
\fontsize{8pt}{8pt}
```{r visualize_lda_theta_heatmap_code}
```
\endgroup
...
\setstretch{1}
\fontsize{8pt}{8pt}
```{r visualize_lda_theta_heatmap, fig.cap = "Heatmap of the posterior means of LDA estimated mixture component values over time."}
...
\setstretch{1}
\fontsize{8pt}{8pt}
```{r visualize_theta_boxplot_code}
```
\endgroup
...
\setstretch{1}
\fontsize{8pt}{8pt}
```{r visualize_theta_boxplot, fig.width = 10, fig.height = 8, fig.cap = ""}
```
\endgroup
\elandscape
...
\setstretch{1}
\fontsize{8pt}{8pt}
```{r visualize-mu, fig.width = 10, fig.height = 6, echo = FALSE}
```
\endgroup
\elandscape
