...
We next transform co[<0;21;30m]unts so that they are not so heavily skewed -- otherwise,
...
$K$ could be hard to interpret, considering there are only 5"6in" samples. We use
...
were large, and where uncertainty was large for estimates at and below 0. At the
