...
Both views draw attention to the two antibiotic time courses, which took place
...
to the finding reported in [@dethlefsen2011incomplete] that Subject F
...
We begin with posterior predictive checks for standard LDA. First, ignoring any
