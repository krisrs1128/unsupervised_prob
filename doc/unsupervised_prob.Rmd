...
fitted $\alpha_{t\left(i\right)}$ (Figure \@ref(fig:visualizealpha)) and
$\mu_{kt}$ (Figure \@ref(fig:visualizemu)) that parallel the earlier ones for
LDA and the unigram model as closely as possible.
